            ...
            <div class="row">
                ...
                <div class="col-md-9 col-xs-12 col-sm-6 col-lg-9">
                    <div class="" style="border-bottom:1px solid black">
                      ...
                      &nbsp;&nbsp;&nbsp;&nbsp;
                      <button id="updateBtn" ><a href="${ctx}/member.do?action=update&page=member_update">정보수정</a></button>
                    </div>
                      <hr>
                    <div class="col-md-6">  
                    <ul class=" details"> 
                      ...
                      <li><p id="email"><span class="glyphicon glyphicon-bold" style="width:50px;"></span>
